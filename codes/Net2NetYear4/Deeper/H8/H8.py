...
#Load Teacher_Model
teacher_model = load_model('H7_teacher.h5')
...
W5b5 = teacher_model.get_layer('h5').get_weights()
W6b6 = teacher_model.get_layer('h6').get_weights()
W7b7 = teacher_model.get_layer('h7').get_weights()
...
# load dataset
X_val = numpy.load('../../../Data/SmoteYear4DataTest.npy')
y_val = numpy.load('../../../Data/SmoteYear4labelTest.npy')
X = numpy.load('../../../Data/SmoteYear4Data.npy')
Y = numpy.load('../../../Data/SmoteYear4label.npy')
...
model.add(Dense(HiddenNeurons, init='identity',name='h6'))#, activation='relu'))
model.add(prelu5)
model.add(Dropout(0.45))

model.add(Dense(HiddenNeurons, init='identity',name='h7'))#, activation='relu'))
model.add(prelu6)
model.add(Dropout(0.45))

model.add(Dense(HiddenNeurons, init='identity',name='h8'))#, activation='relu'))
model.add(prelu7)
model.add(Dropout(0.45))
...
model.get_layer('h7').set_weights(W7b7)
