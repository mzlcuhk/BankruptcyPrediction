...
# load dataset
X_val = numpy.load('../../../Data/SmoteYear3DataTest.npy')
y_val = numpy.load('../../../Data/SmoteYear3labelTest.npy')
X = numpy.load('../../../Data/SmoteYear3Data.npy')
Y = numpy.load('../../../Data/SmoteYear3label.npy')
