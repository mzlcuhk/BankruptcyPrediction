...
#Load Teacher_Model
teacher_model = load_model('H1_teacher.h5')
...
model.add(Dense(HiddenNeurons, init='identity',name='h2'))#, activation='relu'))
model.add(prelu1)
...
model.get_layer('out').set_weights(W2b2)
