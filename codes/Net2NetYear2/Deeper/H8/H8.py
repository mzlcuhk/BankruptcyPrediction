...
X_val = numpy.load('../../../Data/SmoteYear2DataTest.npy')
y_val = numpy.load('../../../Data/SmoteYear2labelTest.npy')
X = numpy.load('../../../Data/SmoteYear2Data.npy')
Y = numpy.load('../../../Data/SmoteYear2label.npy')
